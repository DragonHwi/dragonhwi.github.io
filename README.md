...
### 노블 컨텐츠
 - 노블 스킬 포인트는 길드 컨텐츠인 ___주간 미션___ 과 ___수로___ , ___플래그___ 의 성과에 비례해 매주 ___목요일___ 에 정산됩니다.
...
## 3. 부길드
현재 부길드는 ___매생이죽___ , ___매생이국___ 이 있습니다.
두 길드의 균등한 분배를 위해 가입 인원수를 보고 가급적이면 적은 쪽에 넣어주시면 감사하겠습니다.

### 매생이죽
- 노블 45포
- 길드 컨텐츠 참여 자율
- 주간미션 1점 이상 있는, 접속하고 활동하는 캐릭터들 한에서 노블 권한 부여합니다.
...
__길드 컨텐츠 참여는 자율이지만, 특정인원의 부담을 덜기 위해 자발적으로 수로 및 플래그 참여를 부탁드립니다.__

___가입 신청시, 본 길드에 있는 본캐 닉네임을 함께 기재해주세요.___
...
240128 - 매생이국 잠정 운영 중단
240524 - 노블 완화 이후 매생이죽 기준 변경, 매생이국 안내 삭제
240609 - 매생이죽 길드 컨텐츠 참여 자율로 변경
240823 - 길드 컨텐츠 정산일 수정
240927 - 매생이국 복구 안내 추가
241001 - 매생이국 45포 복구 완료
250704 - 매생이국 운영 중단
```
