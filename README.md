...
#### 노블 권한)
본캐
 - 본캐에 해당하는 직위는 '길드원', '미참', '정리예정'
 - 길드 컨텐츠 미참여시 위 순서로 강등
 - 직위가 '정리예정'임에도 미참여시 정리

부캐
 - 부캐에 해당하는 직위는 '부캐', '부캐미참여'
 - 길드 컨텐츠 참여한 부캐에 한해 '부캐' 직위(노블권한) 부여
...
## 3. 부캐 가입
현재 본 길드는 부캐 가입을 받고있지 않습니다.

부캐 가입을 원하실 경우 ___4. 부길드___ 항목을 참조해주세요.


## 4. 부길드
부캐 및 주보돌이, 유니온, 링크캐릭을 위한 부길드 '매생이죽'이 있습니다.

노블 30포 내외 유지를 목표로 하며, 부담없이 노블스킬을 쓰고 싶으신 분들이 이용하시면 됩니다.

하루에 한번씩 들어온 신청에 대해 일괄 수락하고있으니 이용하시고자 하시면 가입신청을 넣어주세요.

미접일이 길어지면 통보없이 일괄 정리하고있습니다.
